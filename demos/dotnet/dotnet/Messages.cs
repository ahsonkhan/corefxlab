...
namespace dotnet
{
    public static class Messages
    {
        ...
        public const string Compiling = "Invoking Compiler";
        ...
        public const string DnuFailed = "Failed to restore packages.";
        ...
        public const string FailedToGetDependencies =
            "Failed to get the list of dependencies from the project.lock json file.";
