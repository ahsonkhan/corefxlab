...
namespace System.Text.JsonLab
{
    ...
    {
        private static byte[] _initStack = new byte[JsonReader.StackFreeMaxDepth * StackRow.Size];
        ...
        {
            _rentedBuffer = initialSize <= JsonReader.StackFreeMaxDepth * StackRow.Size
                ? _initStack
        ...
        public void Dispose()
        {
            if (_rentedBuffer.Length > JsonReader.StackFreeMaxDepth * StackRow.Size)
