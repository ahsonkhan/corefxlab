...
namespace System.Text.Json.Corefx
{
    ...
    /// </summary>
    public ref partial struct Utf8JsonReaderCustom
    {
        ...
        /// </summary>
        public JsonReaderStateCustom CurrentState => new JsonReaderStateCustom
        {
        ...
        /// </remarks>
        public Utf8JsonReaderCustom(ReadOnlySpan<byte> jsonData, bool isFinalBlock, JsonReaderStateCustom state)
        {
            _buffer = jsonData;
