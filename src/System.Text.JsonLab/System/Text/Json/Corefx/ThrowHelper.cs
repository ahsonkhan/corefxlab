...
namespace System.Text.Json.Corefx
{
    internal static class ThrowHelper
    {
        ...
        public static void ThrowJsonReaderException(ref Utf8JsonReaderCustom json, ExceptionResource resource, byte nextByte = default, ReadOnlySpan<byte> bytes = default)
        {
            throw GetJsonReaderException(ref json, resource, nextByte, bytes);
        }
