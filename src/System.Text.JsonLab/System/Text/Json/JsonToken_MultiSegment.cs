...
namespace System.Text.JsonLab
{
    public partial class JsonReader
    {
        ...
        {
            internal JsonToken(JsonReader jsonReader, in ReadOnlySequence<byte> data, bool isFinalBlock)
            {
                ...
                else
                {
                    ...
                    else if (ConsumeValue(ref reader, first))
                    {
                        ...
                        if (_state.AllowComments)
                        {
                            ...
                            if (_state._tokenType == JsonTokenType.Comment || first == JsonConstants.Solidus)
                            {
                                return true;
                            }
                        }
            ...
            private bool ConsumeNumber(ref BufferReader<byte> reader)
            {
                ...
                _state._position += (int)(reader.Consumed - consumedBefore);
                Value = span;
                ValueType = JsonValueType.Number;
